...
import mods.scourgecraft.ScourgeChest;
...
public class TileEntityIronChest extends TileEntity implements IInventory {
    ...
    public ScourgeChestType getType()
    {
        return type;
    }
    ...
    public void updateEntity()
    {
        ...
        {
            worldObj.addBlockEvent(xCoord, yCoord, zCoord, ScourgeChest.ironChestBlock.blockID, 3, ((numUsingPlayers << 3) & 0xF8) | (facing & 0x7));
        }
    ...
    public void openChest()
    {
        ...
        numUsingPlayers++;
        worldObj.addBlockEvent(xCoord, yCoord, zCoord, ScourgeChest.ironChestBlock.blockID, 1, numUsingPlayers);
    }
    ...
    public TileEntityIronChest applyUpgradeItem(ItemChestChanger itemChestChanger)
    {
        ...
        TileEntityIronChest newEntity = ScourgeChestType.makeEntity(itemChestChanger.getTargetChestOrdinal(getType().ordinal()));
        ...
        ScourgeBlockChest block = ScourgeChest.ironChestBlock;
    ...
    public TileEntityIronChest updateFromMetadata(int l)
    {
        if (worldObj != null && worldObj.isRemote)
        {
            if (l != type.ordinal())
            {
                worldObj.setBlockTileEntity(xCoord, yCoord, zCoord, ScourgeChestType.makeEntity(l));
    ...
    public void handlePacketData(int typeData, int[] intData)
    {
        ...
        if (ScourgeChestType.values()[typeData].isTransparent() && intData != null)
        {
            int pos = 0;
    ...
    void rotateAround(ForgeDirection axis)
    {
        ...
        worldObj.addBlockEvent(xCoord, yCoord, zCoord, ScourgeChest.ironChestBlock.blockID, 2, getFacing());
    }
}